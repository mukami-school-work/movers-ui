  ...
  return (
    <div class="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="flex flex-col items-center mb-16">
        ...
        <div className="max-w-3xl font-bold leading-none tracking-tight text-gray-900 md:mx-auto">
          <span className="text-5xl">Meet the creative minds</span>
        </div>
      </div>
      {/* <!-- End Title --> */}

      {/* <!-- Grid --> */}
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-8 md:gap-12">
