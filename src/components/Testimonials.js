    ...
    <div class="relative overflow-hidden bg-primary-brown">
      <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="max-w-3xl mb-10 font-bold leading-none tracking-tight text-gray-900 lg:text-5xl sm:text-4xl md:mx-auto">
            <span className="text-5xl">Stories from our customers</span>
          </div>
        </div>
        {/* <!-- Grid --> */}
